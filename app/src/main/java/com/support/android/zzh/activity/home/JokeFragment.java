 ...
 * 笑话
 */
public class JokeFragment extends com.support.android.zzh.activity.BaseFragment {
    private RecyclerView rv;
    private com.support.android.zzh.adapter.JokeAdapter madapter;
    ...
    private void setupRecyclerView(RecyclerView recyclerView) {
        ...
        madapter = new com.support.android.zzh.adapter.JokeAdapter(context);
